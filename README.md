...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-27 05:48`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a6145ead-db05-41c2-a381-b2cdc8cb083d.git
$ cd a6145ead-db05-41c2-a381-b2cdc8cb083d
```
